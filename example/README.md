...
- [Troubleshooting](#troubleshooting)
  ...
  - [date-fns locales are missing](#locales-are-missing)
...
### date-fns locales are missing

If you use a [date-fns](https://date-fns.org/), you might notice that only the English locale is available by default.

To add a specific date-fns locale to your bundle, you need to import it explicitly.<br>
For example:
...
If import multiple locales this way, you can later switch between them by passing the locale object as a property to the component:
...
This will only work for locales that have been explicitly imported before. Strings will not work.

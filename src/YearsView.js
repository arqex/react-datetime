...
var DateTimePickerYears = onClickOutside( createClass({
	render: function() {
		...
		}, this.props.prevButtonProps, [viewModes.YEARS]);
	...
	renderYears: function( year ) {
		...
		while (i < 11) {
			...
			props = mergeProps({
				...
				'data-value': year,
				className: classes
			}, this.props.tileProps, [viewModes.YEARS, currentYear, isDisabled]);

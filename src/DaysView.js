...
var DateTimePickerDays = React.createClass({
	...
	render: function() {
		...
		tableChildren = [
			DOM.thead({ key: 'th'}, [
				DOM.tr({ key: 'h'},[
					DOM.th({ key: 'p', className: 'rdtPrev' }, DOM.button({onClick: this.props.subtractTime(1, 'months'), tabIndex: -1, type: 'button' }, '‹')),
					...
					DOM.th({ key: 'n', className: 'rdtNext' }, DOM.button({onClick: this.props.addTime(1, 'months'), tabIndex: -1, type: 'button' }, '›'))
				]),

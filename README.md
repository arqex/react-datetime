...
Different language and date formats are supported by react-datetime. React uses [date-fns](http://momentjs.com/) to format the dates, and the easiest way of changing the language of the calendar is [changing the date-fns locale](http://momentjs.com/docs/#/i18n/changing-locale/).

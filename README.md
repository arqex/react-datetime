...
| **className**      | `string`              | `''`           | Extra class name for the input element.                                                                                                                                                                                                                                                          |
...
| **useNumericDate** | `boolean`             | `false`        | Switch `onChange` callback to use the ms timestamp of the selected Date (`date.getTime()`) instead of the native `Date` type                                                                                                                                                                     |
